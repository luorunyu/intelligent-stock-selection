...
对 10000 积分个人账户，以下数据通常适合用于 A 股选股系统；具体接口仍须以官方积分/频次表和实际调用返回为准：
...
当用户询问下面这些数据时，不要暗示 10000 积分必然足够；报价前要查看最新官方文档。
