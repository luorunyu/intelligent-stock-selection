...
def _candidate_row(code: str, *, active: dict[str, Any], map_entry: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "sw_l1_code": active.get("sw_l1_code"),
        "sw_l1_name": active.get("sw_l1_name"),
        "sw_l2_code": active.get("sw_l2_code"),
        "sw_l2_name": active.get("sw_l2_name"),
        "sw_l3_code": active.get("sw_l3_code"),
        "sw_l3_name": active.get("sw_l3_name"),
        "pct_chg": pct,
        "amount_yi": amount,
